...
func TestDefaultPortableReader_ReadInt64(t *testing.T) {
	...
	classDef := serialization.NewClassDefinition(1, 2, 3)
	classDef.AddField(serialization.NewFieldDefinition(0, "score", serialization.TypeInt64,
		classDef.FactoryID, classDef.ClassID, 0))
	o := NewPositionalObjectDataOutput(0, nil, false)
	pw := NewDefaultPortableWriter(nil, o, classDef)
...
func TestDefaultPortableReader_ReadFloat32(t *testing.T) {
	...
	classDef := serialization.NewClassDefinition(1, 2, 3)
	classDef.AddField(serialization.NewFieldDefinition(0, "rate", serialization.TypeFloat32,
		classDef.FactoryID, classDef.ClassID, 0))
	o := NewPositionalObjectDataOutput(0, nil, false)
	pw := NewDefaultPortableWriter(nil, o, classDef)
...
func TestDefaultPortableReader_ReadFloat64(t *testing.T) {
	...
	classDef := serialization.NewClassDefinition(1, 2, 3)
	classDef.AddField(serialization.NewFieldDefinition(0, "velocity", serialization.TypeFloat64,
		classDef.FactoryID, classDef.ClassID, 0))
	o := NewPositionalObjectDataOutput(0, nil, false)
	pw := NewDefaultPortableWriter(nil, o, classDef)
...
func TestDefaultPortableReader_NilObjects(t *testing.T) {
	...
	classDef.AddField(serialization.NewFieldDefinition(1, "name", serialization.TypeString,
		classDef.FactoryID, classDef.ClassID, 3))
	classDef.AddField(serialization.NewFieldDefinition(2, "a1", serialization.TypeByteArray,
		classDef.FactoryID, classDef.ClassID, 3))
	classDef.AddField(serialization.NewFieldDefinition(3, "a2", serialization.TypeBoolArray,
		classDef.FactoryID, classDef.ClassID, 3))
	classDef.AddField(serialization.NewFieldDefinition(4, "a3", serialization.TypeUInt16Array,
		classDef.FactoryID, classDef.ClassID, 3))
	classDef.AddField(serialization.NewFieldDefinition(5, "a4", serialization.TypeInt16Array,
		classDef.FactoryID, classDef.ClassID, 3))
	classDef.AddField(serialization.NewFieldDefinition(6, "a5", serialization.TypeInt32Array,
		classDef.FactoryID, classDef.ClassID, 3))
	classDef.AddField(serialization.NewFieldDefinition(7, "a6", serialization.TypeInt64Array,
		classDef.FactoryID, classDef.ClassID, 3))
	classDef.AddField(serialization.NewFieldDefinition(8, "a7", serialization.TypeFloat32Array,
		classDef.FactoryID, classDef.ClassID, 3))
	classDef.AddField(serialization.NewFieldDefinition(9, "a8", serialization.TypeFloat64Array,
		classDef.FactoryID, classDef.ClassID, 3))
	classDef.AddField(serialization.NewFieldDefinition(10, "a9", serialization.TypeStringArray,
		classDef.FactoryID, classDef.ClassID, 3))
