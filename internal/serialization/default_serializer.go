...
func (*DateSerializer) GetId() int32 {
	return -22
}

func (*DateSerializer) Read(input DataInput) interface{} {
	var i interface{}
	i, _ = input.ReadDate()
	return i
}

func (*DateSerializer) Write(output DataOutput, i interface{}) {
	output.WriteDate(i.(date))
}*/
