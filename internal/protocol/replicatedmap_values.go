...
func ReplicatedMapValuesDecodeResponse(clientMessage *ClientMessage) *ReplicatedMapValuesResponseParameters {
	// Decode response from client message
	parameters := new(ReplicatedMapValuesResponseParameters)
