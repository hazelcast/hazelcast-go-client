...
func ReplicatedMapSizeDecodeResponse(clientMessage *ClientMessage) *ReplicatedMapSizeResponseParameters {
	// Decode response from client message
	parameters := new(ReplicatedMapSizeResponseParameters)
