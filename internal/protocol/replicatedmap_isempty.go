...
func ReplicatedMapIsEmptyDecodeResponse(clientMessage *ClientMessage) *ReplicatedMapIsEmptyResponseParameters {
    // Decode response from client message
    parameters := new(ReplicatedMapIsEmptyResponseParameters)
