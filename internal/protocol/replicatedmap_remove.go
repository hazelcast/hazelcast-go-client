...
func ReplicatedMapRemoveDecodeResponse(clientMessage *ClientMessage) *ReplicatedMapRemoveResponseParameters {
    // Decode response from client message
    parameters := new(ReplicatedMapRemoveResponseParameters)
