...
func MultiMapValueCountDecodeResponse(clientMessage *ClientMessage) *MultiMapValueCountResponseParameters {
	// Decode response from client message
	parameters := new(MultiMapValueCountResponseParameters)
