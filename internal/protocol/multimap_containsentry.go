...
func MultiMapContainsEntryDecodeResponse(clientMessage *ClientMessage) *MultiMapContainsEntryResponseParameters {
	// Decode response from client message
	parameters := new(MultiMapContainsEntryResponseParameters)
