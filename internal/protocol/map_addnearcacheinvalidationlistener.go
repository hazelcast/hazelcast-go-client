...
type mapAddNearCacheInvalidationListener struct {
}

func (self *mapAddNearCacheInvalidationListener) CalculateSize(args ...interface{}) (dataSize int) {
...
func (self *mapAddNearCacheInvalidationListener) EncodeRequest(args ...interface{}) (request *ClientMessage) {
	// Encode request into clientMessage
	request = NewClientMessage(nil, self.CalculateSize(args))
	request.SetMessageType(MAP_ADDNEARCACHEINVALIDATIONLISTENER)
...
func (self *mapAddNearCacheInvalidationListener) DecodeResponse(clientMessage *ClientMessage, toObject ToObject) (parameters interface{}, err error) {
	// Decode response from client message
	parameters = clientMessage.ReadString()
	return
}

func (self *mapAddNearCacheInvalidationListener) Handle(clientMessage *ClientMessage, handleEventIMapInvalidation func(*Data, *string, *Uuid, int64), handleEventIMapBatchInvalidation func(*[]*Data, *[]*string, *[]*Uuid, *[]*int64)) {
	// Event handler
