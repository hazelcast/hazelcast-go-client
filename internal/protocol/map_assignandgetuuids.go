...
type mapAssignAndGetUuids struct {
}

func (self *mapAssignAndGetUuids) CalculateSize(args ...interface{}) (dataSize int) {
	// Calculates the request payload size
	return
}
func (self *mapAssignAndGetUuids) EncodeRequest(args ...interface{}) (request *ClientMessage) {
	// Encode request into clientMessage
	request = NewClientMessage(nil, self.CalculateSize(args))
	request.SetMessageType(MAP_ASSIGNANDGETUUIDS)
	request.IsRetryable = true
	request.UpdateFrameLength()
	return
}

func (self *mapAssignAndGetUuids) DecodeResponse(clientMessage *ClientMessage, toObject ToObject) (parameters interface{}, err error) {
