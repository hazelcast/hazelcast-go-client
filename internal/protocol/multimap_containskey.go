...
func MultiMapContainsKeyDecodeResponse(clientMessage *ClientMessage) *MultiMapContainsKeyResponseParameters {
	// Decode response from client message
	parameters := new(MultiMapContainsKeyResponseParameters)
