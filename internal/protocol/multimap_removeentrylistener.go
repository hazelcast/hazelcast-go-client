...
func MultiMapRemoveEntryListenerDecodeResponse(clientMessage *ClientMessage) *MultiMapRemoveEntryListenerResponseParameters {
	// Decode response from client message
	parameters := new(MultiMapRemoveEntryListenerResponseParameters)
