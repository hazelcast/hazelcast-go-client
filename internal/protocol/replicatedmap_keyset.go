...
func ReplicatedMapKeySetDecodeResponse(clientMessage *ClientMessage) *ReplicatedMapKeySetResponseParameters {
    // Decode response from client message
    parameters := new(ReplicatedMapKeySetResponseParameters)
