...
func MultiMapContainsValueDecodeResponse(clientMessage *ClientMessage) *MultiMapContainsValueResponseParameters {
	// Decode response from client message
	parameters := new(MultiMapContainsValueResponseParameters)
