...
func MultiMapAddEntryListenerDecodeResponse(clientMessage *ClientMessage) *MultiMapAddEntryListenerResponseParameters {
	// Decode response from client message
	parameters := new(MultiMapAddEntryListenerResponseParameters)
	parameters.Response = clientMessage.ReadString()
	return parameters
}

func MultiMapAddEntryListenerHandle(clientMessage *ClientMessage, handleEventEntry func(*Data, *Data, *Data, *Data, int32, *string, int32)) {
	// Event handler
