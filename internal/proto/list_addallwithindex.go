 ...
 */
//@Generated("89684115dd0917a7cedd499b16b7d544")
const (
    //hex: 0x050E00
...
func ListAddAllWithIndexEncodeRequest(name string, index int32, valueList []serialization.Data) *bufutil.ClientMessage {
...
func ListAddAllWithIndexDecodeResponse(clientMessage *bufutil.ClientMessage) *ListAddAllWithIndexResponseParameters {
