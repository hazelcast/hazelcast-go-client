 ...
 */
//@Generated("77e1bf90c3be3ee04a80ac56ddff9f1b")
const (
    //hex: 0x011900
...
func MapAddEntryListenerEncodeRequest(name string, includeValue bool, listenerFlags int32, localOnly bool) *bufutil.ClientMessage {
...
func MapAddEntryListenerDecodeResponse(clientMessage *bufutil.ClientMessage) *MapAddEntryListenerResponseParameters {
...
func MapAddEntryListenerHandle(clientMessage *bufutil.ClientMessage, handleEventItem MapAddEntryListenerAbstractEventItemFunc){
