 ...
 */
//@Generated("af5ba9401f8eb3bbf788341006f7187e")
const (
    //hex: 0x0E0800
...
func TransactionalMapPutIfAbsentEncodeRequest(name string, txnId UUID, threadId int64, key serialization.Data, value serialization.Data) *bufutil.ClientMessagex {
...
func TransactionalMapPutIfAbsentDecodeRequest(clientMessage *bufutil.ClientMessagex) *TransactionalMapPutIfAbsentRequestParameters {
    iterator := clientMessage.FrameIterator()
    request := new(TransactionalMapPutIfAbsentRequestParameters)
    initialFrame := iterator.Next()
    request.txnId = bufutil.DecodeUUID(initialFrame.Content, TransactionalMapPutIfAbsentRequestTxnIdFieldOffset)
    request.threadId = bufutil.DecodeLong(initialFrame.Content, TransactionalMapPutIfAbsentRequestThreadIdFieldOffset)
...
func TransactionalMapPutIfAbsentEncodeResponse(/* @Nullable */ response serialization.Data ) *bufutil.ClientMessagex {
    clientMessage := bufutil.CreateForEncode()
	initialFrame := bufutil.Frame{make([]byte, TransactionalMapPutIfAbsentResponseInitialFrameSize), bufutil.UnfragmentedMessage}
    bufutil.EncodeInt(initialFrame.Content, bufutil.TypeFieldOffset, TransactionalMapPutIfAbsentResponseMessageType)
    clientMessage.Add(initialFrame)
...
func TransactionalMapPutIfAbsentDecodeResponse(clientMessage *bufutil.ClientMessagex) *TransactionalMapPutIfAbsentResponseParameters {
    iterator := clientMessage.FrameIterator()
