 ...
 */
//@Generated("2e01d0ff683a8f4034aeec79b092fb67")
const (
    //hex: 0x050A00
...
func ListGetAllDecodeRequest(clientMessage *bufutil.ClientMessagex) *ListGetAllRequestParameters {
    iterator := clientMessage.FrameIterator()
    request := new(ListGetAllRequestParameters)
    //empty initial frame
    iterator.Next()
...
func ListGetAllEncodeResponse(response []serialization.Data ) *bufutil.ClientMessagex {
    clientMessage := bufutil.CreateForEncode()
	initialFrame := bufutil.Frame{make([]byte, ListGetAllResponseInitialFrameSize), bufutil.UnfragmentedMessage}
    bufutil.EncodeInt(initialFrame.Content, bufutil.TypeFieldOffset, ListGetAllResponseMessageType)
    clientMessage.Add(initialFrame)
