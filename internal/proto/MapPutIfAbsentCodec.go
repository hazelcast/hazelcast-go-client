 ...
 */
//@Generated("238a0c47b56688ae00985c8e6c6beedb")
const (
    //hex: 0x010E00
...
func MapPutIfAbsentEncodeRequest(name string, key serialization.Data, value serialization.Data, threadId int64, ttl int64) *bufutil.ClientMessagex {
...
func MapPutIfAbsentDecodeRequest(clientMessage *bufutil.ClientMessagex) *MapPutIfAbsentRequestParameters {
    iterator := clientMessage.FrameIterator()
    request := new(MapPutIfAbsentRequestParameters)
    initialFrame := iterator.Next()
    request.threadId = bufutil.DecodeLong(initialFrame.Content, MapPutIfAbsentRequestThreadIdFieldOffset)
    request.ttl = bufutil.DecodeLong(initialFrame.Content, MapPutIfAbsentRequestTtlFieldOffset)
...
func MapPutIfAbsentEncodeResponse(/* @Nullable */ response serialization.Data ) *bufutil.ClientMessagex {
    clientMessage := bufutil.CreateForEncode()
	initialFrame := bufutil.Frame{make([]byte, MapPutIfAbsentResponseInitialFrameSize), bufutil.UnfragmentedMessage}
    bufutil.EncodeInt(initialFrame.Content, bufutil.TypeFieldOffset, MapPutIfAbsentResponseMessageType)
    clientMessage.Add(initialFrame)
...
func MapPutIfAbsentDecodeResponse(clientMessage *bufutil.ClientMessagex) *MapPutIfAbsentResponseParameters {
    iterator := clientMessage.FrameIterator()
