 ...
 */
//@Generated("7b60749b112727290b54e7711e884132")
const (
    //hex: 0x0D0800
...
func ReplicatedMapPutAllEncodeRequest(name string, entries []map[serialization.Data]serialization.Data) *bufutil.ClientMessage {
    ...
    bufutil.StringCodecEncode(clientMessage, name)
        ...
        for k, v = range entries{
           bufutil.DataCodecEncode(clientMessage, k)
           bufutil.DataCodecEncode(clientMessage, v)
        }
...
func ReplicatedMapPutAllDecodeResponse(clientMessage *bufutil.ClientMessage) *ReplicatedMapPutAllResponseParameters {
