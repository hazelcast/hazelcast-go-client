 ...
 */
//@Generated("9be4c91cc48b6ab4d9ecb75d0e27d088")
const (
    //hex: 0x170800
...
func RingbufferAddAllEncodeRequest(name string, valueList []serialization.Data, overflowPolicy int32) *bufutil.ClientMessage {
...
func RingbufferAddAllDecodeResponse(clientMessage *bufutil.ClientMessage) *RingbufferAddAllResponseParameters {
