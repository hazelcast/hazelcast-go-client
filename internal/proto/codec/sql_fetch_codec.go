...
func EncodeSqlFetchRequest(queryId types.QueryID, cursorBufferSize int32) *proto.ClientMessage {
...
func DecodeSqlFetchResponse(clientMessage *proto.ClientMessage, ss *iserialization.Service) (rowPage *types.Page, err error) {
