...
func (clientRemoveDistributedObjectListenerCodec) EncodeRequest(registrationId core.UUID) *proto.ClientMessage {
	...
	internal.FixSizedTypesCodec.EncodeUUID(initialFrame.Content, ClientRemoveDistributedObjectListenerCodecRequestRegistrationIdOffset, registrationId)
...
func (clientRemoveDistributedObjectListenerCodec) DecodeResponse(clientMessage *proto.ClientMessage) bool {
	...
	return internal.FixSizedTypesCodec.DecodeBoolean(initialFrame.Content, ClientRemoveDistributedObjectListenerResponseResponseOffset)
}
