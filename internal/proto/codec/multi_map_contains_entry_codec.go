...
func (multimapContainsEntryCodec) EncodeRequest(name string, key serialization.Data, value serialization.Data, threadId int64) *proto.ClientMessage {
	...
	internal.FixSizedTypesCodec.EncodeLong(initialFrame.Content, MultiMapContainsEntryCodecRequestThreadIdOffset, threadId)
...
func (multimapContainsEntryCodec) DecodeResponse(clientMessage *proto.ClientMessage) bool {
	...
	return internal.FixSizedTypesCodec.DecodeBoolean(initialFrame.Content, MultiMapContainsEntryResponseResponseOffset)
}
