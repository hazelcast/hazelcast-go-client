...
func (listAddAllWithIndexCodec) EncodeRequest(name string, index int32, valueList []serialization.Data) *proto.ClientMessage {
	...
	internal.FixSizedTypesCodec.EncodeInt(initialFrame.Content, ListAddAllWithIndexCodecRequestIndexOffset, index)
...
func (listAddAllWithIndexCodec) DecodeResponse(clientMessage *proto.ClientMessage) bool {
	...
	return internal.FixSizedTypesCodec.DecodeBoolean(initialFrame.Content, ListAddAllWithIndexResponseResponseOffset)
}
