...
type mapKeySetWithPagingPredicateCodec struct{}

var MapKeySetWithPagingPredicateCodec mapKeySetWithPagingPredicateCodec

func (mapKeySetWithPagingPredicateCodec) EncodeRequest(name string, predicate proto.PagingPredicateHolder) *proto.ClientMessage {
