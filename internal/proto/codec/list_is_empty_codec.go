...
func (listIsEmptyCodec) EncodeRequest(name string) *proto.ClientMessage {
	...
	initialFrame := proto.NewFrame(make([]byte, ListIsEmptyCodecRequestInitialFrameSize))
...
func (listIsEmptyCodec) DecodeResponse(clientMessage *proto.ClientMessage) bool {
	...
	return internal.FixSizedTypesCodec.DecodeBoolean(initialFrame.Content, ListIsEmptyResponseResponseOffset)
}
