...
type pncounterGetCodec struct{}

var PNCounterGetCodec pncounterGetCodec

func (pncounterGetCodec) EncodeRequest(name string, replicaTimestamps []proto.Pair, targetReplicaUUID core.UUID) *proto.ClientMessage {
