...
func (codecUtil) EncodeNullableForData(message *proto.ClientMessage, data pubserialization.Data) {
	if data == nil {
		message.AddFrame(proto.NullFrame.Copy())
	} else {
...
func (c codecUtil) DecodeNullableForData(frameIterator *proto.ForwardFrameIterator) pubserialization.Data {
