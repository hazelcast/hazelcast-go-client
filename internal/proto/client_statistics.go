 ...
 */
//@Generated("bc1a7f8ab3f45229894a72c4ac50fcc9")
const (
    //hex: 0x000C00
    ClientStatisticsRequestMessageType = 3072
    //hex: 0x000C01
    ClientStatisticsResponseMessageType = 3073
...
func ClientStatisticsEncodeRequest(timestamp int64, clientAttributes string, metricsBlob []byte) *bufutil.ClientMessage {
...
func ClientStatisticsDecodeResponse(clientMessage *bufutil.ClientMessage) *ClientStatisticsResponseParameters {
