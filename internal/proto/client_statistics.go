 ...
 */
//@Generated("974ad2294e07bac689c28de405f65d71")
const (
    //hex: 0x000C00
    ClientStatisticsRequestMessageType = 3072
    //hex: 0x000C01
    ClientStatisticsResponseMessageType = 3073
    ClientStatisticsRequestTimestampFieldOffset = PartitionIdFieldOffset + IntSizeInBytes
    ClientStatisticsRequestInitialFrameSize = ClientStatisticsRequestTimestampFieldOffset + LongSizeInBytes
    ClientStatisticsResponseInitialFrameSize = CorrelationIdFieldOffset + IntSizeInBytes

)

func ClientStatisticsEncodeRequest(timestamp int64, clientAttributes string, metricsBlob []byte) *ClientMessage {
    ...
    StringCodecEncode(clientMessage, clientAttributes)


    ByteArrayCodecEncode(clientMessage, metricsBlob)

    return clientMessage
}


func ClientStatisticsDecodeResponse(clientMessage *ClientMessage) func() () {
    return func() () {
