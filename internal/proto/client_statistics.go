 ...
 */
//@Generated("2f945cf18f0b899548dbab1f18f281eb")
const (
    //hex: 0x000E00
...
func ClientStatisticsEncodeRequest(timestamp int64, clientAttributes string, metricsBlob []byte) *bufutil.ClientMessagex {
    ...
    bufutil.StringCodecEncode(clientMessage, clientAttributes)
    bufutil.ByteArrayCodecEncode(clientMessage, metricsBlob)
