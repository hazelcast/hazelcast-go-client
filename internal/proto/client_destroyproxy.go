 ...
 */
//@Generated("35711de9addc95d28aca633300a36fcd")
const (
    //hex: 0x000500
...
func ClientDestroyProxyEncodeRequest(name string, serviceName string) *bufutil.ClientMessage {
...
func ClientDestroyProxyDecodeResponse(clientMessage *bufutil.ClientMessage) *ClientDestroyProxyResponseParameters {
