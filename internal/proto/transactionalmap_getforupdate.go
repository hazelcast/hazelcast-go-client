 ...
 */
//@Generated("d9f5f9ba8868acb984e3d177053d828c")
const (
    //hex: 0x0E0300
...
func TransactionalMapGetForUpdateEncodeRequest(name string, txnId string, threadId int64, key serialization.Data) *bufutil.ClientMessage {
...
func TransactionalMapGetForUpdateDecodeResponse(clientMessage *bufutil.ClientMessage) *TransactionalMapGetForUpdateResponseParameters {
