 ...
 */
//@Generated("2c6d1becc3bd63fff8681ac6c4ee04f3")
const (
    //hex: 0x012C00
...
func MapPutAllEncodeRequest(name string, entries []map[serialization.Data]serialization.Data) *bufutil.ClientMessage {
...
func MapPutAllDecodeResponse(clientMessage *bufutil.ClientMessage) *MapPutAllResponseParameters {
