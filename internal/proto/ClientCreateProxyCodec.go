 ...
 * TODO DOC
 */
//@Generated("ef1b74bc9b7fc2f259131d1385825e67")
const (
    //hex: 0x000400
...
func ClientCreateProxyDecodeRequest(clientMessage *bufutil.ClientMessagex) *ClientCreateProxyRequestParameters {
    iterator := clientMessage.FrameIterator()
    request := new(ClientCreateProxyRequestParameters)
    //empty initial frame
    iterator.Next()
...
func ClientCreateProxyEncodeResponse() *bufutil.ClientMessagex {
    clientMessage := bufutil.CreateForEncode()
	initialFrame := bufutil.Frame{make([]byte, ClientCreateProxyResponseInitialFrameSize), bufutil.UnfragmentedMessage}
    bufutil.EncodeInt(initialFrame.Content, bufutil.TypeFieldOffset, ClientCreateProxyResponseMessageType)
    clientMessage.Add(initialFrame)
