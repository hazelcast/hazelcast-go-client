 ...
 */
//@Generated("bc085a0f0c349a68d27fd03bda9fe5d0")
const (
    //hex: 0x000400
...
func ClientCreateProxyEncodeRequest(name string, serviceName string) *bufutil.ClientMessage {
...
func ClientCreateProxyDecodeResponse(clientMessage *bufutil.ClientMessage) *ClientCreateProxyResponseParameters {
