 ...
 */
//@Generated("75d42c771eb76b41d97226b0e449fae7")
const (
    //hex: 0x011D00
...
func MapGetEntryViewEncodeRequest(name string, key serialization.Data, threadId int64) *bufutil.ClientMessage {
...
func MapGetEntryViewDecodeResponse(clientMessage *bufutil.ClientMessage) *MapGetEntryViewResponseParameters {
    ...
    response.response =          bufutil.DecodeNullable(iterator, SimpleEntryViewCodecDecode).(SimpleEntryView)  
    return response
}
