 ...
 */
//@Generated("c8f606611e3457e27d307849940120e0")
const (
    //hex: 0x051500
...
func ListSubEncodeRequest(name string, from int, to int) *bufutil.ClientMessagex {
...
func ListSubDecodeRequest(clientMessage *bufutil.ClientMessagex) *ListSubRequestParameters {
    iterator := clientMessage.FrameIterator()
    request := new(ListSubRequestParameters)
    initialFrame := iterator.Next()
    request.from = bufutil.DecodeInt(initialFrame.Content, ListSubRequestFromFieldOffset)
    request.to = bufutil.DecodeInt(initialFrame.Content, ListSubRequestToFieldOffset)
...
func ListSubEncodeResponse(response []serialization.Data ) *bufutil.ClientMessagex {
    clientMessage := bufutil.CreateForEncode()
	initialFrame := bufutil.Frame{make([]byte, ListSubResponseInitialFrameSize), bufutil.UnfragmentedMessage}
    bufutil.EncodeInt(initialFrame.Content, bufutil.TypeFieldOffset, ListSubResponseMessageType)
    clientMessage.Add(initialFrame)
