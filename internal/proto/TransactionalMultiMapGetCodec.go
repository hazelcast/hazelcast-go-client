 ...
 */
//@Generated("21ade5633538c225922ab4df9888baba")
const (
    //hex: 0x0F0200
...
func TransactionalMultiMapGetEncodeRequest(name string, txnId UUID, threadId int64, key serialization.Data) *bufutil.ClientMessagex {
...
func TransactionalMultiMapGetDecodeRequest(clientMessage *bufutil.ClientMessagex) *TransactionalMultiMapGetRequestParameters {
    iterator := clientMessage.FrameIterator()
    request := new(TransactionalMultiMapGetRequestParameters)
    initialFrame := iterator.Next()
    request.txnId = bufutil.DecodeUUID(initialFrame.Content, TransactionalMultiMapGetRequestTxnIdFieldOffset)
    request.threadId = bufutil.DecodeLong(initialFrame.Content, TransactionalMultiMapGetRequestThreadIdFieldOffset)
...
func TransactionalMultiMapGetEncodeResponse(response []serialization.Data ) *bufutil.ClientMessagex {
    clientMessage := bufutil.CreateForEncode()
	initialFrame := bufutil.Frame{make([]byte, TransactionalMultiMapGetResponseInitialFrameSize), bufutil.UnfragmentedMessage}
    bufutil.EncodeInt(initialFrame.Content, bufutil.TypeFieldOffset, TransactionalMultiMapGetResponseMessageType)
    clientMessage.Add(initialFrame)
...
func TransactionalMultiMapGetDecodeResponse(clientMessage *bufutil.ClientMessagex) *TransactionalMultiMapGetResponseParameters {
    iterator := clientMessage.FrameIterator()
