 ...
 */
//@Generated("f54f8b4aa1c352d257792073ae800c59")
const (
    //hex: 0x011B00
...
func MapAddPartitionLostListenerEncodeRequest(name string, localOnly bool) *bufutil.ClientMessage {
...
func MapAddPartitionLostListenerDecodeResponse(clientMessage *bufutil.ClientMessage) *MapAddPartitionLostListenerResponseParameters {
...
func MapAddPartitionLostListenerHandle(clientMessage *bufutil.ClientMessage, handleEventItem MapAddPartitionLostListenerAbstractEventItemFunc){
