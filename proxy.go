...
func (p *proxy) validateAndSerialize(arg1 interface{}) (pubserialization.Data, error) {
...
func (p *proxy) validateAndSerialize2(arg1 interface{}, arg2 interface{}) (arg1Data pubserialization.Data,
	arg2Data pubserialization.Data, err error) {
...
func (p *proxy) validateAndSerialize3(arg1 interface{}, arg2 interface{}, arg3 interface{}) (arg1Data pubserialization.Data,
	arg2Data pubserialization.Data, arg3Data pubserialization.Data, err error) {
...
func (p *proxy) validateAndSerializeAggregate(agg aggregate.Aggregator) (arg1Data pubserialization.Data, err error) {
...
func (p *proxy) validateAndSerializePredicate(pred predicate.Predicate) (arg1Data pubserialization.Data, err error) {
...
func (p *proxy) validateAndSerializeValues(values []interface{}) ([]pubserialization.Data, error) {
	valuesData := make([]pubserialization.Data, len(values))
...
func (p *proxy) invokeOnKey(ctx context.Context, request *proto.ClientMessage, keyData pubserialization.Data) (*proto.ClientMessage, error) {
...
func (p *proxy) convertToObject(data pubserialization.Data) (interface{}, error) {
	return p.serializationService.ToObject(data)
}

func (p *proxy) convertToObjects(values []pubserialization.Data) ([]interface{}, error) {
...
func (p *proxy) convertToData(object interface{}) (pubserialization.Data, error) {
...
func (p *proxy) decodeEntryNotified(binKey, binValue, binOldValue, binMergingValue pubserialization.Data) (key, value, oldValue, mergingValue interface{}, err error) {
...
func (p *proxy) makeEntryNotifiedListenerHandler(handler EntryNotifiedHandler) entryNotifiedHandler {
	return func(
		binKey, binValue, binOldValue, binMergingValue pubserialization.Data,
		binEventType int32,
		binUUID types.UUID,
