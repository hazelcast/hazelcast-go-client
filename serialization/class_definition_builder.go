...
func NewClassDefinitionBuilder(factoryID int32, classID int32, version int32) *ClassDefinitionBuilder {
	return &ClassDefinitionBuilder{
		...
		classID:          classID,
		version:          version,
		fieldDefinitions: make(map[string]FieldDefinition),
	}
}
...
func (cdb *ClassDefinitionBuilder) AddByteField(fieldName string) error {
	...
	cdb.fieldDefinitions[fieldName] = NewFieldDefinition(cdb.index, fieldName, TypeByte,
		0, 0, cdb.version)
	cdb.index++
	return nil
}
...
func (cdb *ClassDefinitionBuilder) AddBoolField(fieldName string) error {
	...
	cdb.fieldDefinitions[fieldName] = NewFieldDefinition(cdb.index, fieldName, TypeBool,
		0, 0, cdb.version)
	cdb.index++
	return nil
}
...
func (cdb *ClassDefinitionBuilder) AddUInt16Field(fieldName string) error {
	...
	cdb.fieldDefinitions[fieldName] = NewFieldDefinition(cdb.index, fieldName, TypeUint16,
		0, 0, cdb.version)
	cdb.index++
	return nil
}
...
func (cdb *ClassDefinitionBuilder) AddInt16Field(fieldName string) error {
	...
	cdb.fieldDefinitions[fieldName] = NewFieldDefinition(cdb.index, fieldName, TypeInt16,
		0, 0, cdb.version)
	cdb.index++
	return nil
}
...
func (cdb *ClassDefinitionBuilder) AddInt32Field(fieldName string) error {
	...
	cdb.fieldDefinitions[fieldName] = NewFieldDefinition(cdb.index, fieldName, TypeInt32,
		0, 0, cdb.version)
	cdb.index++
	return nil
}
...
func (cdb *ClassDefinitionBuilder) AddInt64Field(fieldName string) error {
	...
	cdb.fieldDefinitions[fieldName] = NewFieldDefinition(cdb.index, fieldName, TypeInt64,
		0, 0, cdb.version)
	cdb.index++
	return nil
}
...
func (cdb *ClassDefinitionBuilder) AddFloat32Field(fieldName string) error {
	...
	cdb.fieldDefinitions[fieldName] = NewFieldDefinition(cdb.index, fieldName, TypeFloat32,
		0, 0, cdb.version)
	cdb.index++
	return nil
}
...
func (cdb *ClassDefinitionBuilder) AddFloat64Field(fieldName string) error {
	...
	cdb.fieldDefinitions[fieldName] = NewFieldDefinition(cdb.index, fieldName, TypeFloat64,
		0, 0, cdb.version)
	cdb.index++
	return nil
}
...
func (cdb *ClassDefinitionBuilder) AddUTFField(fieldName string) error {
	...
	cdb.fieldDefinitions[fieldName] = NewFieldDefinition(cdb.index, fieldName, TypeString,
		0, 0, cdb.version)
	cdb.index++
	return nil
}
...
func (cdb *ClassDefinitionBuilder) AddByteArrayField(fieldName string) error {
	...
	cdb.fieldDefinitions[fieldName] = NewFieldDefinition(cdb.index, fieldName, TypeByteArray,
		0, 0, cdb.version)
	cdb.index++
	return nil
}
...
func (cdb *ClassDefinitionBuilder) AddBoolArrayField(fieldName string) error {
	...
	cdb.fieldDefinitions[fieldName] = NewFieldDefinition(cdb.index, fieldName, TypeBoolArray,
		0, 0, cdb.version)
	cdb.index++
	return nil
}
...
func (cdb *ClassDefinitionBuilder) AddUInt16ArrayField(fieldName string) error {
	...
	cdb.fieldDefinitions[fieldName] = NewFieldDefinition(cdb.index, fieldName, TypeUint16Array,
		0, 0, cdb.version)
	cdb.index++
	return nil
}
...
func (cdb *ClassDefinitionBuilder) AddInt16ArrayField(fieldName string) error {
	...
	cdb.fieldDefinitions[fieldName] = NewFieldDefinition(cdb.index, fieldName, TypeInt16Array,
		0, 0, cdb.version)
	cdb.index++
	return nil
}
...
func (cdb *ClassDefinitionBuilder) AddInt32ArrayField(fieldName string) error {
	...
	cdb.fieldDefinitions[fieldName] = NewFieldDefinition(cdb.index, fieldName, TypeInt32Array,
		0, 0, cdb.version)
	cdb.index++
	return nil
}
...
func (cdb *ClassDefinitionBuilder) AddInt64ArrayField(fieldName string) error {
	...
	cdb.fieldDefinitions[fieldName] = NewFieldDefinition(cdb.index, fieldName, TypeInt64Array,
		0, 0, cdb.version)
	cdb.index++
	return nil
}
...
func (cdb *ClassDefinitionBuilder) AddFloat32ArrayField(fieldName string) error {
	...
	cdb.fieldDefinitions[fieldName] = NewFieldDefinition(cdb.index, fieldName, TypeFloat32Array,
		0, 0, cdb.version)
	cdb.index++
	return nil
}
...
func (cdb *ClassDefinitionBuilder) AddFloat64ArrayField(fieldName string) error {
	...
	cdb.fieldDefinitions[fieldName] = NewFieldDefinition(cdb.index, fieldName, TypeFloat64Array,
		0, 0, cdb.version)
	cdb.index++
	return nil
}

// AddStringArrayField adds []string field to class definition.
func (cdb *ClassDefinitionBuilder) AddStringArrayField(fieldName string) error {
	err := cdb.check()
	if err != nil {
		return err
	}
	cdb.fieldDefinitions[fieldName] = NewFieldDefinition(cdb.index, fieldName, TypeStringArray,
		0, 0, cdb.version)
	cdb.index++
	return nil
}
...
func (cdb *ClassDefinitionBuilder) Build() *ClassDefinition {
	cdb.done = true
	cd := NewClassDefinition(cdb.factoryID, cdb.classID, cdb.version)
