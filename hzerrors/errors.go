...
var (
	...
	ErrCallerNotMember                  = errors.New("caller not member error")
	...
	ErrMemberLeft                       = errors.New("member left error")
	...
	ErrPartitionMigrating               = errors.New("partition migrating error")
	...
	ErrRetryableHazelcast               = errors.New("retryable hazelcast error")
	...
	ErrWrongTarget                      = errors.New("wrong target error")
	...
	ErrTargetNotReplicaException        = errors.New("target not replica exception")
	...
	ErrCannotReplicateException         = errors.New("cannot replicate exception")
