...
var (
	...
	ErrIllegalAccessException           = errors.New("illegal access exception error")
	...
	ErrFlakeIDNodeIDOutOfRangeException = errors.New("flake id nodeid out of range exception error")
	ErrTargetNotReplicaException        = retryable("target not replica exception error")
	ErrMutationDisallowedException      = errors.New("mutation disallowed exception error")
	ErrConsistencyLostException         = errors.New("consistency lost exception error")
	ErrSessionExpiredException          = errors.New("session expired exception error")
	ErrWaitKeyCancelledException        = errors.New("wait key cancelled exception error")
	ErrLockAcquireLimitReachedException = errors.New("lock acquire limit reached exception error")
	ErrLockOwnershipLostException       = errors.New("lock ownership lost exception error")
	ErrCPGroupDestroyedException        = errors.New("cp group destroyed exception error")
	ErrCannotReplicateException         = retryable("cannot replicate exception error")
	ErrLeaderDemotedException           = errors.New("leader demoted exception error")
	ErrStaleAppendRequestException      = errors.New("stale append request exception error")
	ErrNotLeaderException               = errors.New("not leader exception error")
	ErrVersionMismatchException         = errors.New("version mismatch exception error")
	ErrNoSuchMethod                     = errors.New("no such method error")
	ErrNoSuchMethodException            = errors.New("no such method exception error")
