...
//	}
//*/
//func (c *Client) QuerySQL(ctx context.Context, query string, params ...interface{}) (*sql.Row, error) {
...
//
//*/
//func (c *Client) QuerySQLWithOptions(ctx context.Context, query string, opts SQLOptions, params ...interface{}) (*sql.Row, error) {
//	var err error
//	ctx, err = updateContextWithOptions(ctx, opts)
//	if err != nil {
//		return nil, err
